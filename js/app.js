...
function buttonpush1() {
	...
	if (player == 5) {
		document.getElementById("box").innerHTML = ("Tie! <br> The AI chose <br><img src='PIC/squr.png' class='pok2'>")
	}
}
function buttonpush2() {
	...
	if (player == 5) {
		document.getElementById("box").innerHTML = ("Tie! <br> The AI chose <br><img src='PIC/bulb.png' class='pok2'>")
	}
}
function buttonpush3() {
	...
	console.log(player);
	if (player < 5) {
		document.getElementById("box").innerHTML = ("You win<br> The AI chose <br><img src='PIC/bulb.png' class='pok2'>")
	}
	if (player > 5) {
		document.getElementById("box").innerHTML = ("You lose <br> The AI chose <br><img src='PIC/squr.png' class='pok2'>")
	}
	if (player == 5) {
		document.getElementById("box").innerHTML = ("Tie! <br> The AI chose <br><img src='PIC/char.png' class='pok2'>")
	}
}
